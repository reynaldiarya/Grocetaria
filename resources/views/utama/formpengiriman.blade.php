            ...
            <div class="card-body">
                ...
                <form method="post">
                    ...
                    <div class="d-flex flex-row-reverse">
                        <div class="col-2 mx-2"><a class="btn btn-gro text-center d-block w-100" href="form-pengiriman-konfirmasi">Simpan </a></div>
                        <div class="col-2 mx-2"><a class="btn btn-danger text-center d-block w-100" href="keranjang-belanja">Batal </a></div>
                    </div>
                </form>
            </div>
        </div>
