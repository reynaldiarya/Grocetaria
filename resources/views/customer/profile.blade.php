                    ...
                    <form method="POST" action="/profile-update" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="notelp">No Telpon<span class="small text-danger"> *</span></label>
                                        <input type="text" id="notelp" class="form-control" name="notelp" placeholder="08" value="{{ old('notelp', Auth::user()->notelp) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="form-control-label" for="alamatkirim">Alamat<span class="small text-danger"> *</span></label>
                                        <input type="text" id="alamatkirim" class="form-control" name="alamatkirim" placeholder="Alamat" value="{{ old('alamatkirim', Auth::user()->alamatkirim) }}">
                                    </div>
                                </div>
                            </div>
